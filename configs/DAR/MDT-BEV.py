_base_ = [
     '../_base_/models/lss_swin_nuscenes.py']
...
data = dict(
    ...
    train=dict(
        ...
        data_root='./data/nuscenes/',
        img_dir='test/train/img_dir',
        ann_dir='test/train/ann_bev_dir',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='LoadAnnotations',
    ...
    val=dict(
        type='NuscenesDataset',
        data_root='./data/nuscenes/',
        img_dir='for_demo/img_dir',
        ann_dir='for_demo/ann_bev_',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='LoadAnnotations',
    ...
    test=dict(
        type='NuscenesDataset',
        data_root='./data/nuscenes/',
        # img_dir='test/img_val',
        # ann_dir='test/ann_bev_val',
        img_dir='for_demo/img_dir',
        ann_dir='for_demo/ann_bev_dir',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='LoadAnnotations',
...
log_level = 'INFO'
load_from = '/home/XYX/HFT-main/HFT/models_dir/gkt_dar/iter_30000.pth'
# load_from = None
resume_from = '/home/XYX/HFT-main/HFT/models_dir/gkt_dar/iter_30000.pth'
workflow = [('train', 1)]
...
work_dir = './models_dir/DA_nuscenes'
gpu_ids = range(0, 1)
